...
class Subcribe():
    ...
    def writedata (self,data):
        ...
        with open ('/Users/shrutishah/Library/CloudStorage/GoogleDrive-1795898@fcpsschools.net/Shared drives/mindMusic/webproject/data.csv', 'a') as csv_file:
...
def main():
    ...
    with open ('/Users/shrutishah/Library/CloudStorage/GoogleDrive-1795898@fcpsschools.net/Shared drives/mindMusic/webproject/data.csv', 'w') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames)
